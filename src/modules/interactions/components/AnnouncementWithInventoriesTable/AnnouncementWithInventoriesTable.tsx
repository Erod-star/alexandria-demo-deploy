...
interface AnnouncementWithInventoriesTableProps<
  TData extends InventoryData,
  TValue
> {
...
export function AnnouncementWithInventoriesTable<
  TData extends InventoryData,
  TValue
>({ columns, data }: AnnouncementWithInventoriesTableProps<TData, TValue>) {
                    ...
                    {row.getIsExpanded() && (
                      <TableRow>
                        <TableCell colSpan={columns.length} className="h-24">
                          <InventoryRow inventory={row.original.inventory} />
                        </TableCell>
                      </TableRow>
                    )}
                  </React.Fragment>
